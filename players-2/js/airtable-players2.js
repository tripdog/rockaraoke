...
async function fetchMore(current_data) {
  const res = await fetch(`https://api.airtable.com/v0/appSKfLI8nR5HYQRi/2021%20Song%20List?offset=${current_data.offset}`, {
    headers: {
...
async function fetchData() {
  const res = await fetch("https://api.airtable.com/v0/appSKfLI8nR5HYQRi/2021%20Song%20List", {
    headers: {
      Authorization: `Bearer keyBOHvJMQ83qrxYK`,
    },
  });
